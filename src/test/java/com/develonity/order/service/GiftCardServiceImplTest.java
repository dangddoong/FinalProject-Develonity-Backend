...
public class GiftCardServiceImplTest {
    ...
    void registerGiftCard() throws Exception {
        ...
        // given
        GiftCardRegister giftCardRegister = new GiftCardRegister(GiftCardCategory.CAFE, "커피1", "커피1", "이미지1", 4500, 100);
        ...
        Optional<GiftCardImage> foundGiftCardImage = giftCardImageRepository.findByGiftCardId(giftCardId);
        ...
        assertThat(foundGiftCard.get().getStockQuantity()).isEqualTo(giftCardRegister.getStockQuantity());
    ...
    void getGiftCardList() throws Exception {
        ...
        // given
        GiftCardRegister giftCardRegister1 = new GiftCardRegister(GiftCardCategory.CAFE, "커피1", "커피1", "이미지1", 4500, 100);

        MockMultipartFile multipartFile1 = new MockMultipartFile("files", "imageFile1.jpeg", "image/jpeg",
                "<<jpeg data>>".getBytes());

        Long giftCardId1 = giftCardService.registerGiftCard(giftCardRegister1, multipartFile1);

        GiftCardRegister giftCardRegister2 = new GiftCardRegister(GiftCardCategory.CAFE, "커피2", "커피2", "이미지2", 5000, 50);

        MockMultipartFile multipartFile2 = new MockMultipartFile("files", "imageFile2.jpeg", "image/jpeg",
                "<<jpeg data>>".getBytes());
        ...
        Optional<GiftCardImage> foundGiftCardImage1 = giftCardImageRepository.findByGiftCardId(giftCardId1);
        Optional<GiftCardImage> foundGiftCardImage2 = giftCardImageRepository.findByGiftCardId(giftCardId2);
        ...
        assertThat(foundGiftCard1.get().getImagePath()).isEqualTo(foundGiftCardImage1.get().getImagePath());
        assertThat(foundGiftCard1.get().getPrice()).isEqualTo(giftCardRegister1.getPrice());
        assertThat(foundGiftCard1.get().getStockQuantity()).isEqualTo(giftCardRegister1.getStockQuantity());
        ...
        assertThat(foundGiftCard2.get().getImagePath()).isEqualTo(foundGiftCardImage2.get().getImagePath());
        assertThat(foundGiftCard2.get().getPrice()).isEqualTo(giftCardRegister2.getPrice());
        assertThat(foundGiftCard2.get().getStockQuantity()).isEqualTo(giftCardRegister2.getStockQuantity());
    }
    ...
    void updateGiftCard() throws Exception {
        ...
        assertThat(foundGiftCard.get().getStockQuantity()).isEqualTo(giftCardRegister2.getStockQuantity());
    ...
    void deleteGiftCard() throws Exception {
        ...
        // given
        GiftCardRegister giftCardRegister = new GiftCardRegister(GiftCardCategory.CAFE, "커피1", "커피1", "이미지", 4500, 100);
